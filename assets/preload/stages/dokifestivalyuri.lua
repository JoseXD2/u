function onCreate()
    ...
    addAnimationByPrefix('luces','idle','lights back',32, true);
	addLuaSprite('sayori', false);
    addAnimationByPrefix('sayori','idle','Sayori BG',30, true);
    addLuaSprite('monika', false);
    addAnimationByPrefix('monika','idle','Moni BG',30, true);
    addLuaSprite('nat', false);
    addAnimationByPrefix('nat','idle','Natsu BG',30, true);
    addLuaSprite('potra', false);
    addAnimationByPrefix('potra','idle','Protag-kun BG',32, true);
    addLuaSprite('overlay', true);
    addLuaSprite('sillas', false);
    addLuaSprite('luces1', true);
    addAnimationByPrefix('luces1','idle','Lights front',36, true);
